...
void informacao(){
    ...
    cout << centralizar("ADA eh uma aplicacao que visa auxiliar o professor em sala de aula de forma ")
         ...
         << "\n" << centralizar("ministrar. O perfil da turma sera tra�ado baseado no historico dos alunos e ")
...
void exibirFuncoesAlunos(){
    ...
    if(opcao == "1"){
	  ...
	  //  agruparAlunos(alunos,iniInter,fimInter);	
    }
    else if(opcao == "2"){
	...
	//desempPreRequisitos(preR,alunos);	
    }
    else if(opcao == "3"){
       ...
       // desempDiscDesejaveis(desej,alunos);	
    }
    else if(opcao == "4"){
        int n;
...
void exibirFuncoesDisciplina(){
    system("clear||cls");
    cout << "\n\n" << centralizar("funcionalidades")
    << "\n\n" << centralizar("1.exibir desempenho geral da disciplina de n periodos atras ate hoje")
