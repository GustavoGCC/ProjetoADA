...
void Disciplina::cadastraDis(string linha){
    ...
    vector<double> notas;
    char *pEnd;
    notas.push_back(strtod(dadosDisciplina[1].c_str(), &pEnd));
    notas.push_back(strtod(dadosDisciplina[2].c_str(), &pEnd));
    notas.push_back(strtod(dadosDisciplina[3].c_str(), &pEnd));
    disciplina.estagios.insert(pair<double, vector<double> >(strtod(dadosDisciplina[0].c_str(), &pEnd), notas));
    disciplina.indAprovados.insert(pair<double, double>(strtod(dadosDisciplina[0].c_str(), &pEnd), strtod(dadosDisciplina[4].c_str(), &pEnd)));
    disciplina.indReprovPorNota.insert(pair<double, double>(strtod(dadosDisciplina[0].c_str(), &pEnd), strtod(dadosDisciplina[5].c_str(), &pEnd)));
    disciplina.indReprovPorFalta.insert(pair<double, double>(strtod(dadosDisciplina[0].c_str(), &pEnd), strtod(dadosDisciplina[6].c_str(), &pEnd)));


    cout << dadosDisciplina[0]<< dadosDisciplina[1];
   /* Disciplina disciplina;
